...
Ne, Chloros palaiko tik MAPIR fotoaparatų vaizdų apdorojimą. Daugiau informacijos rasite [palaikomų fotoaparatų modelių sąraše](supported-cameras.md). Mes siūlome apdoroti kitų fotoaparatų vaizdus MAPIR Cloud, visą sąrašą rasite [čia](https://mapir.gitbook.io/mapir-cloud/supported-cameras).
...
Ne. Chloros daro prielaidą, kad įvesties duomenys nebuvo pakeisti. Nekeičiokite failų pavadinimų.
...
Jei planuojate įkelti į mūsų internetinę apdorojimo platformą [MAPIR Cloud](https://www.mapir.camera/collections/software/products/mapir-cloud-subscription), prieš įkeliant vaizdų neredaguokite. Debesis atliks visą tą patį apdorojimą ir dar daugiau.
