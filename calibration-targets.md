...
Jei kalibruotus vaizdus išsaugote Chloros kaip įprastą JPG arba TIFF, atspindžio procentas apskaičiuojamas dalijant pikselio vertę iš vaizdo formato bitų gylio. Taigi, JPG atveju dalykite iš 255, o TIFF atveju – iš 65 535. Taip pat galite pasirinkti PERCENT formato išvestį Chloros, tada kiekvienas pikselis bus nuo 0,0 iki 1,0 procentų (0 % iki 100 % atspindžio). Turėkite omenyje, kad kai kurios vaizdo programos nepriima procentinių (plaukiojančiojo kablelio) vaizdų, be to, jie užima daug vietos atmintyje.
