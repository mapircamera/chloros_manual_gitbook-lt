...
1. Spustelėkite mygtuką **„Pridėti failus“** failų naršyklės skydelio viršuje.
...
* Mažas kiekvieno vaizdo peržiūros langas.
...
* **Padidinti/sumažinti**: naudokite pelės ratuką arba mastelio keitimo mygtukus
...
* Išsaugokite originalią aplankų struktūrą iš savo kameros/SD kortelės.
...
* Užfiksuokite tikslinius vaizdus prieš ir po fiksavimo sesijos.
* Pastatykite tikslinius vaizdus tokiomis pačiomis apšvietimo sąlygomis kaip fiksavimo srityje.
...
4. **Pritaikyti nustatymus** – konfigūruokite apdorojimo parinktis [Projekto nustatymai](adjusting-project-settings.md)
