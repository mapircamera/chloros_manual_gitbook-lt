...
Chloros yra prieinama 3 programos režimais:

## Chloros: Darbalaukio GUI programa

Atskiro lango programa su visomis funkcijomis.
...
* **GPU (CUDA) pagreitinimas**: pasinaudokite šiuolaikinėmis didesnės GPU atminties galimybėmis, kad dar labiau pagreitintumėte vaizdų apdorojimo procesą. Norėdami pasiekti geriausių rezultatų, rekomenduojame 4 GB ar daugiau VRAM.
...
* **Naudojimas keliuose įrenginiuose**: kiekviena Chloros+ licencija leidžia registruoti 2 ir daugiau įrenginių. Naudokite savo MAPIR Cloud paskyrą, kad valdytumėte registruotus įrenginius. Pridėkite daugiau įrenginių palaikymą atnaujinant savo Chloros+ licenciją.
* **Pažangus tekstūrą atpažįstantis debayer metodas:** aukštos kokybės kraštus atpažįstantis debayer, derinamas su AI/ML triukšmo šalinimo modeliu, kuris pašalina beveik visą debayering triukšmą.
* **Individualizuotos multispektrinės indeksų formulės:** įveskite individualizuotus multispektrinius indeksus Chloros rastro skaičiuoklėse, tiek apdorojimui, tiek vaizdų peržiūros smėlio dėžėje.
